...
const SubscriptionSection = () => {
  ...
  const handlePaymentSubmit = async () => {
    try {
      ...
      const response = await createSubscription(sendData);

      Swal.fire({
        title: "Success!",
        text: response?.success || "Subscription created successfully",
        icon: "success",
      });
  ...
  return (
    <>
      ...
      <Modal show={showInvoice} onHide={handleInvoiceClose} centered>
        <Modal.Header
          closeButton
          style={{ background: "linear-gradient(90deg, #D36314, #FF8C00)" }}
        >
            ...
            {subscriptionData?.verify === 1 ? (
              <>
                <p className="text-muted">
                  ...
                  <strong>Tigo Pesa Lipa number</strong> below, then paste your
                  payment code and send to WhatsApp and system.
                </p>
