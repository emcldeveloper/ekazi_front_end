...
const JobFitSection = ({ applicant }) => {
  ...
  return (
    <div className="jobs-fit-section mt-8">
      {/* Header */}
      <div className="d-flex justify-content-between align-items-center mb-2">
        <h5 className="section-title mb-0 fw-bold">LIST OF JOBS I MAY FIT</h5>
