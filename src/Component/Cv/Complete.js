...
const CompleteCv = () => {
  ...
  // const { data, isPending: loading, isError: error } = useCv(uuid);
  ...
  const handleSaveAndDownload = () => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        console.error(
          "Error occurred during saving or downloading the CV:",
          error,
        );
        Swal.fire({
          title: "Error!",
  ...
  return originalDetails == null ? (
    ...
    <div>
      <div
        className={`flex flex-col transition-all duration-300 ${margin}  items-center justify-center h-screen`}
      >
        <div className="">
          <svg
        ...
        <h1
          ...
          className="font-bold cursor-pointer hover:text-opacity-70 transition-all text-darkShadow mt-2"
        >
          Go back
        </h1>
